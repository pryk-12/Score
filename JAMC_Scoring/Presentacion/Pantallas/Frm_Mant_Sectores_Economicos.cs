...
{
	public partial class Frm_Mant_Sectores_Economicos : Frm_Plantilla
	{
		public Frm_Mant_Sectores_Economicos()
		{
			InitializeComponent();
		}
        ...
        public void Consultar()
        {
            ...
            {
                condicion = "ID_SECTOR_ECONOMICO =" + txt_buscar.Text + "";
            }
            ...
            dg.DataSource = N_Sector_Economico.Consultar_Datos(condicion);
        ...
        public void Editar()
        {
            ...
            obj._ID_SECTOR_ECONOMICO = Convert.ToInt32(dg.CurrentRow.Cells["_ID"].Value.ToString());
            obj._PUNTOS = Convert.ToDouble(dg.CurrentRow.Cells["PUNTOS"].Value.ToString());
            Frm_Sector_Economico frm = new Frm_Sector_Economico();
        ...
        private void Frm_Mant_Sectores_Economicos_Load(object sender, EventArgs e)
        {
